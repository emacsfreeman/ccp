...
alphabetFile.write('\n\\vspace{2cm}')
alphabetFile.write('\n\\begin{figure}[h!]\n')
alphabetFile.write('\n\\includegraphics[width=0.95\\textwidth, height=15cm]{../russian_img/katsiaryna-endruszkiewicz-russian-girl-unsplash.jpg}\n')
alphabetFile.write('\n\\caption{Photo by Katsiaryna Endruszkiewicz on \\url{https://unsplash.com}}\n')
alphabetFile.write('\n\\end{figure}\n')
alphabetFile.write('\\vspace{1cm}')
alphabetFile.write('\n\\end{center}\n')
alphabetFile.write('\\newpage\n')
...
alphabetFile.write('\n\\vspace{2cm}\n')
alphabetFile.write('Visit my blog on languages: \\url{www.polyglothuman.fr}\\par\n')
alphabetFile.write('\n\\includegraphics[width=.95\\textwidth, scale=.25]{../russian_img/chapka.JPG}\\par\n')
alphabetFile.write('Visit my blog on Russian: \\url{www.govoritparoussky.fr}\\par\n')
alphabetFile.write('\n\\end{center}\n')
alphabetFile.write('\\newpage\n')

alphabetFile.write('\n\\begin{center}\n')
alphabetFile.write('\n Visit my blog on languages :\\url{www.polyglothuman.fr}\\par\n')
alphabetFile.write('\n\\includegraphics[scale=3]{../russian_img/russianFreePic6.jpg}\\par\n')
alphabetFile.write('\n Visit my blog on Russian :\\url{www.govoritparoussky.fr}\\par\n')
alphabetFile.write('\n\\end{center}\n')
alphabetFile.write('\n\\end{titlepage}\n')
